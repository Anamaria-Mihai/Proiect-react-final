...
export default function Transferuri() {
    ...
    const handleTransferClick = () => {
        ...
        if (isNaN(parsedInputValue) || parsedInputValue <= 0) {
            // Verifică dacă inputValueThree nu este un număr sau este negativ
            return;
        }
        ...
        if (sourceCardIndex !== -1) {
            ...
            setInputValueThree(''); // Resetează valoarea inputului pentru SUMA
        }
    };
